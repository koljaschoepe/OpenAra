...
# ---------------------------------------------------------------------------
# Note: n8n binds to 127.0.0.1:5678 in docker-compose.yml (secure by default).
# Access n8n via SSH tunnel: ssh -L 5678:localhost:5678 mydevice
# Or use Tailscale Funnel for remote access (see below).
# No UFW rules needed — Docker port binding handles access control.
# ---------------------------------------------------------------------------
