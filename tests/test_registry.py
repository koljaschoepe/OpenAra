"""Tests for CommandRegistry — registration, lookup, aliases, prefix matching.

Strategy: Uses a fresh CommandRegistry per test (not the global REGISTRY)
to isolate registry behavior from actual command handlers.
"""
